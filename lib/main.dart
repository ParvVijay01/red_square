...
//   /// Moves the square to the right position within bounds.
//   /// Calculates a quarter of the screen width to position it.
//   void _moveRight() {
//     if (_isAnimating) return;
//     _animateSquare(MediaQuery.of(context).size.width / 4);
//   }

//   /// Moves the square to the left position within bounds.
//   /// Calculates a quarter of the screen width in the negative direction.
//   void _moveLeft() {
//     if (_isAnimating) return;
//     _animateSquare(-MediaQuery.of(context).size.width / 4);
//   }
...
//             ),
//             ElevatedButton(
//               onPressed: _isAnimating ? null : _moveToCenter,
